...
- Jenkins jobs for build and deployment to AWS cloud for spring-boot app, lambda function, step function, S3 ref-data files and config files, Cloudwatch rules, RDS database, DocumentDB, log delivery stream, etc.
